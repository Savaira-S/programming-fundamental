...
void showMenu(){ system("cls");
        ...
        void viewTransactions( int u, string dateArrayU1[], 
            string categoryArrayU1[], float amArrayU1[],
            bool isExpenseArrayU1[], string dateArrayU2[],
            string categoryArrayU2[], float amArrayU2[], 
            bool isExpenseArrayU2[], int indexUser[]){
...
void calculateBalance(int u, string dateArrayU1[], 
    float amArrayU1[], bool isExpenseArrayU1[], 
    string dateArrayU2[], float amArrayU2[],
     bool isExpenseArrayU2[], int indexUser[],
      float &totalExpenses,
     float &totalIncome){
        totalExpenses = 0;
     ...
     void updateTransaction(int u, string dateArrayU1[], 
    float amArrayU1[], bool isExpenseArrayU1[], 
    string dateArrayU2[], float amArrayU2[],
     bool isExpenseArrayU2[], int indexUser[],
     string categoryArrayU1[],string categoryArrayU2[]
     ){
         if (indexUser[u] == 0)
            {
...
void deleteTranscation(int u, string dateArrayU1[], 
    float amArrayU1[], bool isExpenseArrayU1[], 
    string dateArrayU2[], float amArrayU2[],
     bool isExpenseArrayU2[], int indexUser[],
     string categoryArrayU1[],string categoryArrayU2[]){
...
int main()
{
    ...
    while (true)
    {
       showMenu();
        ...
        {
            system("cls");
            viewTransactions(  u,  dateArrayU1, 
             categoryArrayU1,   amArrayU1 ,
              isExpenseArrayU1,  dateArrayU2,
              categoryArrayU2,  amArrayU2, 
             isExpenseArrayU2,  indexUser);
        ...
        else if (choice == 3)
        {
            ...
            calculateBalance(u, dateArrayU1, amArrayU1,
                 isExpenseArrayU1, dateArrayU2, amArrayU2,
                 isExpenseArrayU2, indexUser, 
        ...
        else if (choice == 5)
        {
            ...
            updateTransaction(  u, dateArrayU1, 
     amArrayU1, isExpenseArrayU1, 
     dateArrayU2,  amArrayU2,
     isExpenseArrayU2, indexUser,
     categoryArrayU1, categoryArrayU2);
        ...
        else if (choice == 6)
        {
            system("cls");
             ...
             deleteTranscation(u, dateArrayU1, 
     amArrayU1, isExpenseArrayU1, 
     dateArrayU2,  amArrayU2,
     isExpenseArrayU2, indexUser,
     categoryArrayU1, categoryArrayU2);
     ...
     amArrayU1, isExpenseArrayU1, 
       amArrayU2,
     isExpenseArrayU2, indexUser, totalIncome);
     ...
     amArrayU1, isExpenseArrayU1, 
       amArrayU2,
     isExpenseArrayU2, indexUser, totalExpense);
